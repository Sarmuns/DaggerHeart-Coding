...
Taste is trained, not innate; unseen details compound; beauty is leverage. Full philosophy lives in SKILL.md ("Philosophy (internalize this)"). This file covers execution craft only: easing, springs, clip-path, stagger, performance, debugging.
